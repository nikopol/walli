...
<?php } ?>
	...
	<script>
		...
		var hash=function(){var b,d,e=function(a){return a.toString().replace(/&/g,"%26").replace(/=/g,"%3D")},g=function(a){var f=[],c;for(c in b)f.push(e(c)+"="+e(b[c]));a&&(d=f.join("&"));document.location.hash="#"+f.join("&");return!0},k=function(){b={};d=document.location.href.replace(/^.*?#/,"");d.length&&d.split("&").forEach(function(a){a=a.split("=");1<a.length&&(b[decodeURIComponent(a[0])]=decodeURIComponent(a[1]))})};k();return{del:function(a,f){return void 0!=b[a]?(delete b[a],g(f)):!1},set:function(a,f,c){return g(c,"object"==typeof a?b=a:b[a]=f)},get:function(a){return void 0==a?b:b[a]||""},link:function(a){var b=[];if(a)for(var c in a)b.push(c+"="+e(a[c]));return"#"+b.join("&")},onchange:function(a){window.onhashchange=function(){document.location.href.replace(/^.*?#/,"")!=d&&(k(),a&&a())}}}}(),hotkeys=function(){var b=!1,d={ESC:27,TAB:9,SPACE:32,RETURN:13,ENTER:13,BACKSPACE:8,BS:8,SCROLL:145,CAPSLOCK:20,NUMLOCK:144,PAUSE:19,INSERT:45,DEL:46,HOME:36,END:35,PAGEUP:33,PAGEDOWN:34,LEFT:37,UP:38,
		RIGHT:39,DOWN:40,F1:112,F2:113,F3:114,F4:115,F5:116,F6:117,F7:118,F8:119,F9:120,F10:121,F11:122,F12:123,"*":106,"+":107,"-":109,".":110,"/":111,";":186,"=":187,",":188,"`":192,"[":219,"\\":220,"]":221,"'":222},e={ALT:1,CONTROL:2,CTRL:2,SHIFT:4},g=[],k=function(a){a||(a=window.event);var b,c,d=String.fromCharCode(a.which||a.charCode).toUpperCase(),h=a.shiftKey*e.SHIFT|a.ctrlKey*e.CTRL|a.altKey*e.ALT;for(b in g)if(c=g[b],!(a.which!=c.key&&d!=c.key||h!=c.mask||!c.glob&&/INPUT|SELECT|TEXTAREA|KBD/.test(document.activeElement.tagName)&&
		27!=c.key))return c.fn(a),a.stopPropagation(),a.preventDefault(),!1;return!0};return{clear:function(){document.onkeydown=null;b=!1;g=[];return this},add:function(a,f,c){var l=0,h=0;"string"==typeof a&&(a=[a]);a.forEach(function(a){"string"==typeof a&&("+"==a?["+"]:a.toUpperCase().split("+")).forEach(function(a){e[a]?l|=e[a]:h=d[a]?d[a]:a[0]});h?(g.push({key:h,fn:f,glob:c,mask:l||0}),b||(document.onkeydown=k,b=!0)):console.error("hotkey "+a+" unknown")});return this}}}(),browser=function(){var b={},
	...
	<script>
		...
		B()),W())}function ga(a){var d=_("#diapo"+n).parentNode,p=_("#minicom"+n);p&&d.removeChild(p);0<a&&append(d,'<span id="minicom'+n+'" class="minicom">'+a+"</span>")}function $(a,d){if(d||r&&T!==a)T=a,r&&(css(k[1-f],""),x(1-f,2)),a?(css("#bcom","+active"),css(M,"+com"+(d?"fix":"")),hash.set("com",1,!0)):(css("#bcom","-active"),css(M,"-com"),css(M,"-comfix"),hash.del("com",!0)),r&&setTimeout(function(){x(f,0)},550)}function aa(a){var d="",p=G[a];p&&p.length?(p.forEach(function(c,q){d+="<li><header>"+
		c.who+' <span title="'+c.when.replace("T"," ")+'">'+loc.reldate(c.when)+"</span></header><content>"+c.what.replace("\n","<br/>")+"</content>"+(c.own?'<button class="del" onclick="walli.rmcom(\''+a.replace("'","\\'")+"',"+c.id+')">'+loc.bdel+"</button>":"")+"</li>"}),_(O,d),O.scrollTop=O.scrollHeight,_("#comcount",g(p.length))):(_(O,loc.nocom),_("#comcount","0"))}function na(a,d){ajax({type:"POST",url:"?!=comment",data:{file:h[n],who:a,what:d},ok:function(a){G[a.file]=a.coms;aa(h[n]);ga(a.coms.length);
		N.value=""},error:osd.error})}function oa(a,d){ajax({type:"POST",url:"?!=uncomment",data:{file:a,id:d},ok:function(a){G[a.file]=a.coms;aa(h[n]);ga(a.coms.length)},error:osd.error})}function z(a){a&&a.stopPropagation&&a.stopPropagation()}function W(){r?hash.set("f",h[n],!0):s?hash.set("f",s,!0):hash.del("f",!0)}function ha(){var a=hash.get("f"),d=hash.get("com"),e=/^(.+\/)([^\/]*)$/.test(a)?RegExp.$1:"/",c=RegExp.$2;d?$(!0,!0):T&&$(!1,!0);return a.length?(d=function(){var d=h.indexOf(a),c=0;r&&d!=
		n&&(c=d<n?-1:1);-1!=d?walli.show(d,c):E("thumb")},e!=s?l(e,d):c?d():E("thumb"),!0):!1}function C(a,d,e){if(!r){var c=J[s]?J[s]:{x:0,y:0,n:0};e&&(c.x=a,c.y=d);c.o&&css(c.o,"-cursor");var q=_("#diapos li"),g=_("#diapos"),l=g.getBoundingClientRect(),b=[],f=!1,m=-1,h,k,n;if(q.length){for(;++m<q.length;)if(h=q[m].getBoundingClientRect(),h={t:h.top-l.top+g.scrollTop,w:h.width,h:h.height},h.w){k=Math.round(h.t+h.h/2);if(!1===f||k>f)f=k,b.push([]),n=b.length-1;b[n].push({t:h.t,b:h.t+h.h,n:m});e||c.n!=m||
		(c={x:a+b[n].length-1,y:d+n,n:m})}c.y>n?c.y=0:0>c.y&&(c.y=n);c.x>=b[c.y].length?c.x=0:0>c.x&&(c.x=b[c.y].length-1);k=b[c.y][c.x];c.o=q[k.n];c.n=k.n;h={t:g.scrollTop,b:g.scrollTop+l.height,h:l.height};n=h.t;k.b>h.b?n=k.b-h.h+30:k.t<h.t&&(n=k.t-30);g.scrollTop=n;css(c.o,"+cursor")}J[s]=c}}function ia(){r&&osd.info(e(h[n])+" <sup>"+(n+1)+"/"+h.length+"</sup>")}var L=5,ma=3,K=!1,F=!1,D=!1,V,s,h=[],I=[],A=[],n=!1,f=0,k=[],X=[],M,P,N,U=0,S=!1,r,t,u={},G=[],T,Z,O,ja,y=!1,H=!0,ea=0,fa=0,J={},v,ba,ka={boxed:{make:function(){var a=
		...
		"px",width:q[g]+"px",height:q[p]+"px"})},u=function(a,d,c,p){var k=function(){var c=document.createElement("img");c.onload=function(){osd.inc();log.debug(a+" loaded");css(this.parentNode,"+loaded")};c.onerror=function(){osd.inc();log.error("loading "+a)};c.onclick=d;return c}(),l=Math.random(),h=document.createElement("li");css(h,"diapo "+c);h.appendChild(k);h.setAttribute("title",e(a));void 0!=p&&(k.id="diapo"+p,(H||y)&&append(h,'<input type="checkbox" id="chk'+p+'" n="'+p+'" onchange="walli.zwap('+
		p+')"/><label for="chk'+p+'"></label>'));(G[a]||[]).length&&append(h,'<span class="minicom">'+g(G[a].length)+"</span>");diapos.appendChild(h);"dir"==c||0==f&&0==m?(c=2,p=1<b?2:1):1<b-f&&.5<l&&!s(f,m,2,1)?(c=.8<l&&n>b?2:1,p=2):(c=.7<l&&n>b?2:1,p=1);t(h,f,m,p,c);for(k.src="?!=mini&file="+encodeURIComponent(a)+"&w="+q[p]+"&h="+q[c];s(f,m,1,1);)f++,f>=b&&(f=0,m++);n--};_("#diapos","");osd.start(h.length+I.length);I.forEach(function(a){u(a,function(){l(a)},"dir")});h.forEach(function(a,d){setTimeout(function(){u(a,
		function(){walli.show(d,0)},"",d)},10*d)})}},build:function(){v.lastnc=0;this.make()},resize:function(){this.make()},rotate:function(){this.make()}},"default":{build:function(){var a=function(a,p,c,q){var b=function(){var c=document.createElement("img");c.onload=function(){osd.inc();log.debug(a+" loaded");css(this.parentNode,"+loaded")};c.onclick=p;return c}(),f=document.createElement("li");css(f,"diapo "+c);f.appendChild(b);f.setAttribute("title",e(a));void 0!=q&&(b.id="diapo"+q,(H||y)&&append(f,
		'<input type="checkbox" id="chk'+q+'" n="'+q+'" onchange="walli.zwap('+q+')"/><label for="chk'+q+'"></label>'));(G[a]||[]).length&&append(f,'<span class="minicom">'+g(G[a].length)+"</span>");diapos.appendChild(f);b.src="?!=mini&file="+encodeURIComponent(a)+"&w="+v.size+"&h="+v.size};osd.start(h.length+I.length);I.forEach(function(d){a(d,function(){l(d)},"dir")});h.forEach(function(d,b){setTimeout(function(){a(d,function(){walli.show(b,0)},"",b)},b)})},resize:function(){},rotate:function(){}}};return{setup:function(a){ja=
		a.comments;V=a.refresh;y=a.god;H=a.zip;v=a.thumbnail||{engine:"default",size:150,margin:0};v.layout=ka[v.engine]||ka["default"];ba=a.slider||"default";M=_("#view");O=_("#coms");t=_("#slide");css(t,"+"+ba);t.onmousewheel=function(a){r&&(0>(a.wheelDelta||a.detail/3)?walli.prev():walli.next(),a.preventDefault())};var d=function(){k[f].className="animated";k[f].style.left=u.l+"px";u={}};t.onmousedown=t.ontouchstart=function(a){a.preventDefault();a.touches&&(a=a.touches[0]);k[f].className="touch";u={c:u.c||
		0,d:!0,m:!1,x:a.pageX,l:parseInt(k[f].style.left,10),h:setTimeout(d,1E3)}};t.onmousemove=t.ontouchmove=function(a){u.d&&(u.m=!0,a.preventDefault(),a.touches&&(a=a.touches[0]),a=a.pageX-u.x,k[f].style.left=u.l+a+"px",80<Math.abs(a)&&(clearTimeout(u.h),u={},k[f].className="animated",80<a?walli.prev():walli.next()))};t.onmouseup=t.onmouseout=t.ontouchend=t.ontouchcancel=function(a){a.preventDefault();u.d&&(clearTimeout(u.h),u.c?(clearTimeout(u.c),d(),walli.toggleplay()):u.m?d():u.c=setTimeout(function(){d();
