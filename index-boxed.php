...
<head>
	...
	<style>
		...
		*{margin:0;padding:0;outline-style:none}
		body{overflow:hidden;-webkit-font-smoothing:subpixel-antialiased !important;background:#fff;font:normal 16px "Righteous";color:#ccc}
		body.sleep{cursor:none}
		a,a:visited{text-decoration:none}
		input[type="text"],textarea,select{width:380px;font:normal 16px "Righteous";border:none;background-color:#222;color:#fff;padding:0;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px}
		ul{list-style:none}
		...
		#copyright{position:absolute;z-index:99;bottom:2px;right:20px;bottom:2px;right:2px}
		...
		#osd{display:none;position:absolute;top:0;left:0;right:0;height:40px;z-index:0;color:#fff;font:bold 30px Arial;opacity:0;text-align:center;padding:0 10px;background-color:rgba(0,0,0,0.2);-webkit-transition:all 0.5s ease;-moz-transition:all 0.5s ease;transition:all 0.5s ease;font:normal 30px Righteous;background-color:rgba(0,0,0,0.4);top:5px;left:70px;right:70px;-moz-border-radius:20px;-webkit-border-radius:20px;border-radius:20px}
		...
		#progressbar{position:absolute;height:25px;background-color:rgba(255,255,255,0.2);z-index:51;background-color:rgba(0, 0, 0, 0.2)}
		...
		#thumbbar{position:absolute;left:0;right:0;top:0;padding:5px 5px 0 20px;font-size:0;clear-after:both;background:#ccc;box-shadow:#000 0 0 5px;margin-bottom:5px}
		#thumbbar h1{font:bold 24px Arial;display:inline;margin:0 4px 0 -14px;padding:0 12px;cursor:default;font:bold 32px "Righteous";line-height:34px;color:rgba(127,127,127,0.8);text-shadow:1px 1px 1px #ccc, 0 0 0 #000}
		#thumbbar button{position:relative;display:inline;height:28px;font:normal 18px Arial;vertical-align:top;padding:0 5px;font:normal 18px Righteous;color:#fff;background:#aaa;box-shadow:#999 4px 4px 0;margin:0 8px 0 0;-webkit-transition:all 0.2s linear;-moz-transition:all 0.2s linear;transition:all 0.2s linear;-webkit-transform:skewX(-15deg);-moz-transform:skewX(-15deg);transform:skewX(-15deg);max-width:200px;text-overflow:ellipsis}
		...
		li.diapo{position:relative;display:inline;float:left;width:150px;height:168px;overflow:hidden;text-align:center;vertical-align:bottom;margin:5px;padding:0;background-color:#fff;box-shadow:#333 1px 1px 8px}
		...
		#view{position:absolute;overflow:hidden;top:0;bottom:0;left:0;right:0;opacity:0;z-index:0;-webkit-transition:all 0.5s linear;-moz-transition:all 0.5s linear;transition:all 0.5s linear;background:#555}
		...
		#view #comments{position:absolute;top:40px;left:-300px;bottom:0;width:300px;z-index:7;overflow:hidden;-webkit-transition:all 0.5s ease;-moz-transition:all 0.5s ease;transition:all 0.5s ease;color:#fff;background-color:#555}
		...
		#mask #loading{position:absolute;bottom:28px;left:0;right:0;text-align:center;font:normal 32px Arial;color:#fff;font:normal 32px Righteous;text-shadow:0 0 10px #fff}
		...
		#godbar{position:absolute;right:20px;top:15px;width:16px;z-index:30;top:8px;right:8px;width:160px}
		...
		#diag{position:absolute;color:#fff;top:40px;right:40px;overflow:auto;border-radius:4px;background-color:#333;z-index:90;padding:6px;-webkit-box-shadow:3px 3px 5px #000;-moz-box-shadow:3px 3px 5px #000;box-shadow:3px 3px 5px #000;background:#ccc;color:#777;border-radius:0;top:50px;right:20px}
		...
		#copyright a,#copyright a:visited{color:#aaa;text-shadow:#fff 1px 0}
		#thumbbar h1:hover{}
		#thumbbar button:hover{background:#bbb;-webkit-transition:all 0.2s linear;-moz-transition:all 0.2s linear;transition:all 0.2s linear}
		#thumbbar button:active{box-shadow:none;margin:4px 4px 0 4px}
		#diapos{}
		li.diapo:hover,li.diapo.cursor{z-index:2;color:#eee;-webkit-transform:scale(1.1);-moz-transform:scale(1.1);-webkit-box-shadow:0 0 20px rgba(0,0,0,.9);-moz-box-shadow:0 0 20px rgba(0,0,0,.9);box-shadow:0 0 20px rgba(0,0,0,.9);-webkit-transition:all 0.2s linear;-moz-transition:all 0.2s linear;transition:all 0.2s linear}
		li.diapo:after{content:attr(title);display:table-cell;vertical-align:middle;position:absolute;width:100%;bottom:0;background-color:rgba(0,0,0,.6);padding:5px 0;color:#fff;-webkit-transition:all 0.2s linear;-moz-transition:all 0.2s linear;transition:all 0.2s linear;-webkit-transform:translateY(100%);-moz-transform:translateY(100%);transform:translateY(100%)}
		li.diapo:hover:after,li.diapo.cursor:after{-webkit-transition:all 0.2s linear;-moz-transition:all 0.2s linear;transition:all 0.2s linear;-webkit-transform:translateY(0);-moz-transform:translateY(0);transform:translateY(0)}
		...
		#viewbar button#bcom span{position:absolute;left:0;top:4px;width:48px;text-align:center;font:bold 24px Righteous}
...
<?php } ?>
	...
	<script>
		...
		g=l;_("#progresstext",w.replace(/%v/,l).replace(/%m/,e));l>=e&&(css(b,"-active"),B&&B());css("#progressbar",{width:e?Math.floor(position("#progress").width*l/e)+"px":0})},inc:function(){osd.set(++g)}}}();var walli;
		walli=function(){function m(){var a=_("#thumbbar"),d=position(a),a=window.getComputedStyle(a);css("#diapos",{top:d.top+d.height+parseInt(a.getPropertyValue("marginBottom"))+"px"})}function b(a,d){H&&(_("#bzip",d).className=a,m())}function w(a,d){var p=h[a],c,q=Date.now();c=new Image;U++;c.onload=function(c){c||(c=window.event);log.info("image #"+a+" "+p+" loaded in "+(Date.now()-q)/1E3+"s");d(a,c.target||c.srcElement);U--};c.onerror=function(){log.error("error loading "+("image #"+a+" "+p));d(a,null);
		U--};c.src=encodeURIComponent(p)}function e(a){a=/([^\/]+)\/$/.test(a)?RegExp.$1:a.replace(/^.*\//g,"");return a.replace(/\.[^\.]*$/,"").replace(/[\._\|]/g," ")}function g(a){return 999<a?Math.floor(a/1E3)+"K+":a}function B(){V&&!F&&(F=setInterval(function(){log.debug("refresh required");ajax("?!=count&path="+s,function(a){I.length==a.dirs&&h.length==a.files||l(s)})},1E3*V))}function l(a,d){F&&(clearInterval(F),F=!1);log.debug("loading path "+(a||"/"));b("hide",loc.dlall);y&&css("#bdel","hide");A=
		[];osd.hide();ajax("?!=ls&path="+a,function(a){var c=_("#diapos","");s=a.path;log.info((s||"/")+"loaded with "+a.dirs.length+" subdirs and "+a.files.length+" files found");if(s.length){var q=s.replace(/[^\/]+\/$/,"/"),R=document.createElement("li");css(R,"diapo up loaded");R.setAttribute("title",loc.updir);R.onclick=function(){l(q)};c.appendChild(R);var e="",g="";s.split("/").forEach(function(a){a&&(e+=a+"/",g+="<button onclick=\"walli.cd('"+e+"')\">"+htmlencode(a)+"</button>")});_("#path",g);m()}else _("#path",
		"");h=a.files;I=a.dirs;G=a.coms;d&&d();v.layout.build();a.files.length&&H&&b("all");W();B();y&&_("#diag")&&walli.diag();J[s]&&C(0,0)})}function x(a,d){if(X[a]){var p=t.clientWidth,c=t.clientHeight,q=X[a],e=q.h,g=q.w;g>p&&(g=p,e=Math.floor(q.h/q.w*g));e>c&&(e=c,g=Math.floor(q.w/q.h*e));css(k[a],{width:g+"px",height:e+"px",left:Math.floor((p-g)/2+p*d*2)+"px",top:Math.floor((c-e)/2)+"px"})}}function ca(){S&&(K&&clearTimeout(K),K=setTimeout(walli.next,1E3*L))}function Q(a){L+=a;0>L&&(L=0);osd.loc("delay",
		{s:L})}function da(){css(document.body,"-sleep");document.body.onmousemove=document.body.ontouchstart=function(a){if(a.x!=ea||a.y!=fa)ea=a.x,fa=a.y,da()};D&&clearTimeout(D);D=setTimeout(la,1E3*ma)}function la(){D&&(D=clearTimeout(D));css(document.body,"+sleep")}function Y(a){S!==a&&((S=a)?(ca(),a=document.documentElement,a.requestFullscreen?a.requestFullscreen():a.mozRequestFullScreen?a.mozRequestFullScreen():a.webkitRequestFullScreen&&a.webkitRequestFullScreen(),css("#bplay","+active"),css("#view",
		"+play"),osd.loc("play"),da()):(K&&(K=clearTimeout(K)),D&&(D=clearTimeout(D)),document.body.onmousemove=document.body.ontouchstart=!1,css(document.body,"-sleep"),css("#bplay","-active"),css("#view","-play"),osd.loc("stop")))}function E(a){Z!==a&&(Z=a,log.debug("switch to "+a+" mode"),r=!0,"tof"==Z?(F&&(clearInterval(F),F=!1),css(M,"+active"),css("#thumb","-active")):(r=!1,Y(!1),osd.hide(),css(k[0],""),css(k[1],""),css(M,"-active"),css("#exif","-active"),css("#thumb","+active"),B()),W())}function ga(a){var d=
		_("#diapo"+n).parentNode,p=_("#minicom"+n);p&&d.removeChild(p);0<a&&append(d,'<span id="minicom'+n+'" class="minicom">'+a+"</span>")}function $(a,d){if(d||r&&T!==a)T=a,r&&(css(k[1-f],""),x(1-f,2)),a?(css("#bcom","+active"),css(M,"+com"+(d?"fix":"")),hash.set("com",1,!0)):(css("#bcom","-active"),css(M,"-com"),css(M,"-comfix"),hash.del("com",!0)),r&&setTimeout(function(){x(f,0)},550)}function aa(a){var d="",p=G[a];p&&p.length?(p.forEach(function(c,q){d+="<li><header>"+c.who+' <span title="'+c.when.replace("T",
		" ")+'">'+loc.reldate(c.when)+"</span></header><content>"+c.what.replace("\n","<br/>")+"</content>"+(c.own?'<button class="del" onclick="walli.rmcom(\''+a.replace("'","\\'")+"',"+c.id+')">'+loc.bdel+"</button>":"")+"</li>"}),_(O,d),O.scrollTop=O.scrollHeight,_("#comcount",g(p.length))):(_(O,loc.nocom),_("#comcount","0"))}function na(a,d){ajax({type:"POST",url:"?!=comment",data:{file:h[n],who:a,what:d},ok:function(a){G[a.file]=a.coms;aa(h[n]);ga(a.coms.length);N.value=""},error:osd.error})}function oa(a,
		d){ajax({type:"POST",url:"?!=uncomment",data:{file:a,id:d},ok:function(a){G[a.file]=a.coms;aa(h[n]);ga(a.coms.length)},error:osd.error})}function z(a){a&&a.stopPropagation&&a.stopPropagation()}function W(){r?hash.set("f",h[n],!0):s?hash.set("f",s,!0):hash.del("f",!0)}function ha(){var a=hash.get("f"),d=hash.get("com"),e=/^(.+\/)([^\/]*)$/.test(a)?RegExp.$1:"/",c=RegExp.$2;d?$(!0,!0):T&&$(!1,!0);return a.length?(d=function(){var d=h.indexOf(a),c=0;r&&d!=n&&(c=d<n?-1:1);-1!=d?walli.show(d,c):E("thumb")},
		e!=s?l(e,d):c?d():E("thumb"),!0):!1}function C(a,d,e){if(!r){var c=J[s]?J[s]:{x:0,y:0,n:0};e&&(c.x=a,c.y=d);c.o&&css(c.o,"-cursor");var q=_("#diapos li"),g=_("#diapos"),l=g.getBoundingClientRect(),b=[],f=!1,m=-1,h,k,n;if(q.length){for(;++m<q.length;)if(h=q[m].getBoundingClientRect(),h={t:h.top-l.top+g.scrollTop,w:h.width,h:h.height},h.w){k=Math.round(h.t+h.h/2);if(!1===f||k>f)f=k,b.push([]),n=b.length-1;b[n].push({t:h.t,b:h.t+h.h,n:m});e||c.n!=m||(c={x:a+b[n].length-1,y:d+n,n:m})}c.y>n?c.y=0:0>c.y&&
		(c.y=n);c.x>=b[c.y].length?c.x=0:0>c.x&&(c.x=b[c.y].length-1);k=b[c.y][c.x];c.o=q[k.n];c.n=k.n;h={t:g.scrollTop,b:g.scrollTop+l.height,h:l.height};n=h.t;k.b>h.b?n=k.b-h.h+30:k.t<h.t&&(n=k.t-30);g.scrollTop=n;css(c.o,"+cursor")}J[s]=c}}function ia(){r&&osd.info(e(h[n])+" <sup>"+(n+1)+"/"+h.length+"</sup>")}var L=5,ma=3,K=!1,F=!1,D=!1,V,s,h=[],I=[],A=[],n=!1,f=0,k=[],X=[],M,P,N,U=0,S=!1,r,t,u={},G=[],T,Z,O,ja,y=!1,H=!0,ea=0,fa=0,J={},v,ba,ka={boxed:{make:function(){var a=v.size,d=v.margin,p=_("#diapos"),
		c=[0,a+2*d,2*a+4*d],q=[0,a,2*a+2*d],b=Math.floor(_(p).clientWidth/c[1]);1>b&&(b=1);if(b!=v.lastnc){v.lastnc=b;var f=0,m=0,k=[],n=I.length+h.length,r=function(a,d){var c,q;for(c=q=0;q<d;c+=1<<q++);return c<<a},s=function(a,d,c,q){for(c=r(a,c);k.length<d+q;)k.push(0);for(a=0;a<q;++a)if(k[d+a]&c)return!0;return!1},t=function(a,e,b,g,p){for(var f,m=r(e,g);k.length<b+p;)k.push(0);for(f=0;f<p;++f)k[b+f]|=m;css(a,{position:"absolute",margin:d,left:c[1]*e+"px",top:c[1]*b+"px",width:q[g]+"px",height:q[p]+
		"px"})},u=function(a,d,c,p){var k=function(){var c=document.createElement("img");c.onload=function(){osd.inc();log.debug(a+" loaded");css(this.parentNode,"+loaded")};c.onerror=function(){osd.inc();log.error("loading "+a)};c.onclick=d;return c}(),l=Math.random(),h=document.createElement("li");css(h,"diapo "+c);h.appendChild(k);h.setAttribute("title",e(a));void 0!=p&&(k.id="diapo"+p,(H||y)&&append(h,'<input type="checkbox" id="chk'+p+'" n="'+p+'" onchange="walli.zwap('+p+')"/><label for="chk'+p+'"></label>'));
		(G[a]||[]).length&&append(h,'<span class="minicom">'+g(G[a].length)+"</span>");diapos.appendChild(h);"dir"==c||0==f&&0==m?(c=2,p=1<b?2:1):1<b-f&&.5<l&&!s(f,m,2,1)?(c=.8<l&&n>b?2:1,p=2):(c=.7<l&&n>b?2:1,p=1);t(h,f,m,p,c);for(k.src="?!=mini&file="+encodeURIComponent(a)+"&w="+q[p]+"&h="+q[c];s(f,m,1,1);)f++,f>=b&&(f=0,m++);n--};_("#diapos","");osd.start(h.length+I.length);I.forEach(function(a){u(a,function(){l(a)},"dir")});h.forEach(function(a,d){setTimeout(function(){u(a,function(){walli.show(d,0)},
		"",d)},10*d)})}},build:function(){v.lastnc=0;this.make()},resize:function(){this.make()},rotate:function(){this.make()}},"default":{build:function(){var a=function(a,p,c,q){var b=function(){var c=document.createElement("img");c.onload=function(){osd.inc();log.debug(a+" loaded");css(this.parentNode,"+loaded")};c.onclick=p;return c}(),f=document.createElement("li");css(f,"diapo "+c);f.appendChild(b);f.setAttribute("title",e(a));void 0!=q&&(b.id="diapo"+q,(H||y)&&append(f,'<input type="checkbox" id="chk'+
		q+'" n="'+q+'" onchange="walli.zwap('+q+')"/><label for="chk'+q+'"></label>'));(G[a]||[]).length&&append(f,'<span class="minicom">'+g(G[a].length)+"</span>");diapos.appendChild(f);b.src="?!=mini&file="+encodeURIComponent(a)+"&w="+v.size+"&h="+v.size};osd.start(h.length+I.length);I.forEach(function(d){a(d,function(){l(d)},"dir")});h.forEach(function(d,b){setTimeout(function(){a(d,function(){walli.show(b,0)},"",b)},b)})},resize:function(){},rotate:function(){}}};return{setup:function(a){ja=a.comments;
		V=a.refresh;y=a.god;H=a.zip;v=a.thumbnail||{engine:"default",size:150,margin:0};v.layout=ka[v.engine]||ka["default"];ba=a.slider||"default";M=_("#view");O=_("#coms");t=_("#slide");css(t,"+"+ba);t.onmousewheel=function(a){r&&(0>(a.wheelDelta||a.detail/3)?walli.prev():walli.next(),a.preventDefault())};var d=function(){k[f].className="animated";k[f].style.left=u.l+"px";u={}};t.onmousedown=t.ontouchstart=function(a){a.preventDefault();a.touches&&(a=a.touches[0]);k[f].className="touch";u={c:u.c||0,d:!0,
		m:!1,x:a.pageX,l:parseInt(k[f].style.left,10),h:setTimeout(d,1E3)}};t.onmousemove=t.ontouchmove=function(a){u.d&&(u.m=!0,a.preventDefault(),a.touches&&(a=a.touches[0]),a=a.pageX-u.x,k[f].style.left=u.l+a+"px",80<Math.abs(a)&&(clearTimeout(u.h),u={},k[f].className="animated",80<a?walli.prev():walli.next()))};t.onmouseup=t.onmouseout=t.ontouchend=t.ontouchcancel=function(a){a.preventDefault();u.d&&(clearTimeout(u.h),u.c?(clearTimeout(u.c),d(),walli.toggleplay()):u.m?d():u.c=setTimeout(function(){d();
		walli.next()},250))};k=[_("#img0"),_("#img1")];t.ondragstart=k[0].ondragstart=k[1].ondragstart=function(a){a.preventDefault();return!1};window.onresize=function(){r&&(k[1-f].className="",x(1-f,1),x(f,0));m();v.layout.resize()};window.onorientationchange=function(){var a=_("#viewport"),d=window.orientation||0;a.setAttribute("content",90==d||-90==d||270==d?"height=device-width,width=device-height,initial-scale=1.0,maximum-scale=1.0":"height=device-height,width=device-width,initial-scale=1.0,maximum-scale=1.0");
		r&&x(f,0);v.layout.rotate()};hotkeys.add("CTRL+D",function(){css("#log","*active")},!0).add(["SPACE","ENTER"],walli.toggleplay).add("C",walli.togglecom).add("HOME",walli.first).add("LEFT",walli.prev).add("RIGHT",walli.next).add("UP",walli.up).add("DOWN",walli.down).add("PAGEUP",walli.pgup).add("PAGEDOWN",walli.pgdown).add("END",walli.last).add(["ESC","BACKSPACE"],walli.back).add("DOWN",function(){!r&&h.length&&walli.show(0)}).add(["?","H"],function(){css("#help","*active")}).add(["T"],ia).add(["I"],
		...
		path:s},ok:function(){l(s)},error:osd.error})},dlzip:function(){var a=A.length?h.filter(function(a,b){return-1!=A.indexOf(b)}):h;H&&a.length?(_("#bzip",loc.zip),ajax({type:"POST",url:"?!=zip",data:{files:a.join("*")},ok:function(a){document.location="?!=zip&zip="+a.zip;walli.zwap()},error:osd.error})):osd.loc("nozip")},zwap:function(a){void 0!=a&&(-1==A.indexOf(a)?A.push(a):A=A.filter(function(d){return d!=a}));A.length?(b("selected",loc.tpl("dlsel",{nb:A.length})),y&&css("#bdel","")):(b("all",loc.dlall),
		y&&css("#bdel","hide"))},thumb:function(){E("thumb")},show:function(a,d,b){h.length&&(n=0>a?h.length+a:a>=h.length?a%h.length:a,r||E("tof"),css("#mask","+active"),w(n,function(a,b){css("#mask","-active");r?f=1-f:d=0;X[f]={w:b.width,h:b.height};t.removeChild(k[f]);k[f].src=b.src;if(d)"box"==ba?(css(k[f],0<d?"left":"right"),x(f,0),t.appendChild(k[f]),x(f,0),css(k[f],"animated center"),css(k[1-f],"animated "+(0>d?"left":"right")),x(1-f,0)):(css(k[f],0>d?"left":"right"),x(f,d),t.appendChild(k[f]),x(f,
		0),css(k[f],"animated center"),css(k[1-f],"animated "+(0<d?"left":"right")),x(1-f,-d));else{css(k[f],"");var e=position("#diapo"+n);css(k[f],{width:e.width+"px",height:e.height+"px",left:e.left+"px",top:e.top+"px"});t.appendChild(k[f]);css(k[f],"animated");x(f,0)}ca();W();ia();walli.exif();1<h.length&&w((n+1)%h.length,function(){})}),aa(h[n]))},next:function(a){z(a);r?walli.show(n+1,1):C(1,0)},prev:function(a){z(a);r?walli.show(n-1,-1):C(-1,0)},down:function(a){z(a);r?walli.show(n+1,1):C(0,1)},up:function(a){z(a);
		r?walli.show(n-1,-1):C(0,-1)},pgdown:function(a){z(a);r?walli.show(n+5,1):C(0,5)},pgup:function(a){z(a);r?walli.show(n-5,-1):C(0,-5)},first:function(a){z(a);r?walli.show(0,-1):C(0,0,!0)},last:function(a){z(a);r?walli.show(-1,1):C(-1,-1,!0)},play:function(a){z(a);h.length&&(r||walli.show(n,0),E("tof"))},stop:function(a){z(a);E("thumb")},toggleplay:function(a){z(a);r?Y(!S):(J[s]||C(0,0,!0),J[s].o&&J[s].o.children[0].click(a))},togglecom:function(a){a&&a.stopPropagation();$(!T)},sendcom:function(){1>
		P.value.length?(osd.loc("emptywho"),P.focus()):1>N.value.length?(osd.loc("emptywhat"),N.focus()):na(P.value,N.value)},rmcom:function(a,b){oa(a,b)},back:function(){if(r)return E("thumb");var a=s.split("/");1<a.length&&l(a.slice(0,a.length-2).join("/"))},cd:function(a){E("thumb");l(a)}}}();
	</script>
	<script>
		ready(function(){
			walli.setup({
