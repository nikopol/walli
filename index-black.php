...
<head>
	...
	<style>
		...
		*{margin:0;padding:0}
		...
		body{background:#000;font:normal 16px "Baumans";color:#ccc}
		button{margin:0;padding:0;border:none;background-color:transparent}
		input[type="text"],textarea,select{font:normal 16px "Baumans";border:none;background-color:#222;color:#fff;padding:0;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px}
		...
		#osd{font:bold 30px Baumans;text-shadow:0 4px 3px rgba(0, 0, 0, 0.4), 0 8px 10px rgba(0, 0, 0, 0.1), 0 8px 9px rgba(0, 0, 0, 0.1)}
		#thumbbar h1{font:bold 24px "Baumans";color:#eee;background:#333}
		#thumbbar h1:hover{background:#666;text-shadow:0 0 10px #fff}
		#thumbbar button{font:normal 18px Baumans;color:#ccc;background:#444;padding:0 30px 0 14px;margin:0 -9px 4px 0}
		...
		li.diapo{background-color:#000}
		li.diapo.loaded{color:#999}
		...
		#view{background:#000}
		#view #comments{color:#fff;background-color:#000}
		#coms li{background:#222;border-radius:2px}
		#coms li header{color:#888;font-size:12px}
		#coms li button.del{color:#eee}
		...
		#viewbar{background-color:#000}
		#viewbar button{color:#eee}
		#bcom span{font:bold 24px Baumans}
		#bcom:hover span{text-shadow:0 0 5px #fff}
		#mask #loading{color:#fff;font:normal 32px Baumans;text-shadow:0 0 10px #fff}
		...
		#intro{background-color:rgba(50,50,50,0.6)}
		#intro h1{color:#fff}
		#godbar{width:16px}
		#godbar button{height:16px;width:16px;margin:0 0 3px 0;opacity:0.3;border:none}
